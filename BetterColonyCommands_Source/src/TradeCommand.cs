...
namespace ColonyCommands
{
	...
	public class TradeChatCommand : IChatCommand
	{
		...
		public bool TryDoCommand(Players.Player causedBy, string chattext, List<string> splits)
		{
			...
			if (!PermissionsManager.CheckAndWarnPermission(causedBy, AntiGrief.MOD_PREFIX + "trade")) {
				return true;
			}
			...
			if (sourceColony.ColonyGroup.Stockpile.TryRemove(tradeItem)) {
				targetColony.ColonyGroup.Stockpile.Add(tradeItem);
