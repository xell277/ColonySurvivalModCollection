...
/*		public CustomProtectionArea(JToken json)
		{
			StartX = json["StartX"].Value<int>();
			StartZ = json["StartZ"].Value<int>();
			EndX = json["EndX"].Value<int>();
			EndZ = json["EndZ"].Value<int>();
		}
*/
...
/*
		...
		{
			return new JToken.FromObject(this);
		}
*/
