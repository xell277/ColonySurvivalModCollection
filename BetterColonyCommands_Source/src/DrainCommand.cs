  ...
  public class DrainChatCommand : IChatCommand
  {
    ...
    public bool TryDoCommand (Players.Player causedBy, string chattext, List<string> splits)
    {
      ...
      foreach (Vector3Int toCheckPosition in new Vector3Int[] {
          causedBy.PositionVoxelStanding,
          causedBy.PositionVoxelStanding.Add(0, 1, 0),
          causedBy.PositionVoxelStanding.Add(0, 2, 0)
        }) {
        ushort actualType;
      ...
      if (toCheckWaterBlocks.Count < 1) {
        Chat.Send (causedBy, $"No water found at {causedBy.PositionStanding}. Please get your feet wet!");
        return true;
      }
